namespace DigitalLearningSolutions.Web.Tests.Services.GroupServiceTests
{
    ...
    partial class GroupsServiceTests
    {
        ...
        {
            // Given
            A.CallTo(() => groupsDataService.GetGroupCourseIfVisibleToCentre(A<int>._, A<int>._)).Returns(null);
            ...
            A.CallTo(() => groupsDataService.GetGroupCourseIfVisibleToCentre(25, 15)).MustHaveHappenedOnceExactly();
        }
        ...
        public void GetActiveGroupCourse_returns_null_when_data_service_returns_inactive_course()
        {
            ...
            var groupCourse = Builder<GroupCourse>.CreateNew()
                ...
                .Build();
            A.CallTo(() => groupsDataService.GetGroupCourseIfVisibleToCentre(A<int>._, A<int>._))
                .Returns(groupCourse);
        ...
        public void GetActiveGroupCourse_returns_groupCourse_from_data_service()
        {
            ...
            A.CallTo(() => groupsDataService.GetGroupCourseIfVisibleToCentre(25, 101)).MustHaveHappenedOnceExactly();
        }
