    ...
    public class NotificationService : INotificationService
    {
        ...
        public async Task SendUnlockRequest(int progressId)
        {
            ...
            var baseUrlConfigOption = refactoredTrackingSystemEnabled
                ? ConfigurationExtensions.GetAppRootPath(configuration)
                : ConfigurationExtensions.GetCurrentSystemBaseUrl(configuration);
        ...
        )
        {
            ...
            var finaliseUrl = ConfigurationExtensions.GetCurrentSystemBaseUrl(configuration) + "/tracking/finalise" +
